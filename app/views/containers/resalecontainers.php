                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    if($last != 1){
                                        ...
                                        $paginationCtrls .= '<li><a href="'.HTTP.HTTPURL.PUB.CONTAINERS.'/resalecontainers/?pn=1">First</a></li>';

                                        if ($pagenum > 1) {
                                            $previous = $pagenum - 1;
                                            $paginationCtrls .= '<li><a href="'.HTTP.HTTPURL.PUB.CONTAINERS.'/resalecontainers/?pn='.$previous.'">Previous</a></li>';
                                            // Render clickable number links that should appear on the left of the target page number
                                            for($i = $pagenum-2; $i < $pagenum; $i++){
                                                if($i > 0){
                                                    $paginationCtrls .= '<li><a href="'.HTTP.HTTPURL.PUB.CONTAINERS.'/resalecontainers/?pn='.$i.'">'.$i.'</a></li>';
                                                }
                                            }
                                        }

                                        // Render the target page number, but without it being a link
                                        $paginationCtrls .= '<li class="active"><a href="'.HTTP.HTTPURL.PUB.CONTAINERS.'/resalecontainers/?pn='.$pagenum.'">'.$pagenum.'</a></li>';
                                        ...
                                        if ($pagenum != $last) {
                                            $next = $pagenum + 1;
                                            $paginationCtrls .= '<li><a href="'.HTTP.HTTPURL.PUB.CONTAINERS.'/resalecontainers/?pn='.$next.'">Next</a></li>';
                                        }

                                        $paginationCtrls .= '<li><a href="'.HTTP.HTTPURL.PUB.CONTAINERS.'/resalecontainers/?pn='.$last.'">Last</a></li>';
                                    }
