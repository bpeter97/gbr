                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    if($last != 1){
                                        ...
                                        $paginationCtrls .= '<li><a href="'.Config::get('site/siteurl').'/containers/rentalcontainers/?pn=1">First</a></li>';

                                        if ($pagenum > 1) {
                                            $previous = $pagenum - 1;
                                            $paginationCtrls .= '<li><a href="'.Config::get('site/siteurl').'/containers/rentalcontainers/?pn='.$previous.'">Previous</a></li>';
                                            // Render clickable number links that should appear on the left of the target page number
                                            for($i = $pagenum-2; $i < $pagenum; $i++){
                                                if($i > 0){
                                                    $paginationCtrls .= '<li><a href="'.Config::get('site/siteurl').'/containers/rentalcontainers/?pn='.$i.'">'.$i.'</a></li>';
                                                }
                                            }
                                        }

                                        // Render the target page number, but without it being a link
                                        $paginationCtrls .= '<li class="active"><a href="'.Config::get('site/siteurl').'/containers/rentalcontainers/?pn='.$pagenum.'">'.$pagenum.'</a></li>';
                                        ...
                                        if ($pagenum != $last) {
                                            $next = $pagenum + 1;
                                            $paginationCtrls .= '<li><a href="'.Config::get('site/siteurl').'/containers/rentalcontainers/?pn='.$next.'">Next</a></li>';
                                        }

                                        $paginationCtrls .= '<li><a href="'.Config::get('site/siteurl').'/containers/rentalcontainers/?pn='.$last.'">Last</a></li>';
                                    }
