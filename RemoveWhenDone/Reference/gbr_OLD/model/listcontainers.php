<?php
	...
	// Pagination Query
	$db->sql('SELECT COUNT(container_ID) FROM containers');
	...
	$db->sql('SELECT * FROM containers ORDER BY container_number '.$limit);
	...
	if($response) {
		...
		foreach($response as $row) {
			...
			<tbody>
				<tr class="clickable-row '.$danger.'" data-href="'.HTTP.HTTPURL.CONTROLLERS.'/editcontainer.php?of=mastercontainers&action=edit&id=' . $row['container_ID'].'" '.$tooltip.'>
					...
					<td>
						<a class="btn btn-xs btn-warning" href="'.HTTP.HTTPURL.CONTROLLERS.'/editcontainer.php?of=mastercontainers&action=edit&id=' . $row['container_ID'].'">
					  	<span class="glyphicon glyphicon-pencil"></span>
						</a>
						<a class="btn btn-xs btn-danger" href="'.HTTP.HTTPURL.CONTROLLERS.'/editcontainer.php?of=mastercontainers&action=delete&id=' . $row['container_ID'].'">
