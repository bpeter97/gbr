<?php
	...
	if(isset($_GET['pqid'])){
		$pqid = $_GET['pqid'];
		$sql = 'SELECT product_name, product_qty, product_cost, product_msn FROM product_orders WHERE order_id = '.$pqid;
		$db->sql($sql);
		$qitems = $db->getResult();

		// Grab the number of rows within result.
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
	                            <?php
	                            	// This will change to pull information on the display pages or not.
	                            	if(isset($_GET['pqid'])){
	                            		echo '<form action="../model/createorder.php?pqid='.$pqid.'" method="post">';
	                            	} else {
	                            		echo '<form action="../model/createorder.php" method="post">';
	                            	}
	                            ?>
		                            <div class="row"><!-- 1st Row -->
		                                <div class="col-lg-12">
		                                    <div class="form-group">
		                                        <label class="control-label col-md-4" for="frmorderdate">Order Date</label>
		                                        <div class="col-md-8">
		                                            <div class="form-group">
		                                                <div class='input-group'>
		                                                    <input id="frmorderdate" name="frmorderdate" class="form-control" placeholder="" type="text" required="true" value="<?php echo $_SESSION['order_date']; ?>">
		                                            ...
		                                            <p class="help-block">Select the date the order was requested.</p>
		                                        </div>
		                                    </div>
		                                </div>
		                            </div><!-- End of 1st Row -->
		                            <div class="row"><!-- 2nd Row -->
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label class="col-md-4 control-label" for="frmordertime">Order Time</label>
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        <div class='input-group'>
                                                            <input id="frmordertime" name="frmordertime" class="form-control datepicker" placeholder="00:00:00" type="text" value="<?php echo $_SESSION['order_time']; ?>">
                                                            <span class="input-group-addon">
		                            ...
		                            <div class="row"><!-- 4th Row -->
		                                <div class="col-lg-12">
		                                    ...
		                                    <div class="col-md-8">
		                                        <select class="form-control" name="frmordertype" id="frmordertype" required="true">
		                                        	<?php
		                                        		echo '<option selected>'.$_SESSION["order_type"].'</option>';
		                                        	?>
			                        ...
			                        <div class="row"><!-- 9th Row -->
                                        <div class="col-lg-12">
                                            ...
                                            <div class="col-md-8">
                                                <input class="form-control" type="text" name="frmcontact" value="<?php echo $_SESSION['onsite_contact']; ?>">
                                    ...
                                    <div class="row"><!-- 10th Row -->
                                        <div class="col-lg-12">
                                            ...
                                            <div class="col-md-8">
                                                <input class="form-control" type="text" placeholder="000-000-0000" name="frmcontactphone" value="<?php echo $_SESSION['onsite_contact_phone']; ?>">
	                                        ...
	                                        <table class="table table-hover">
	                                            ...
	                                            <?php
                                        			...
                                        			<tr>
														...
														<td><a style="color:black;" href="createorder.php?action=remove&code=<?php echo $item["mod_short_name"]; ?>">Remove Item</a></td>
													</tr>
                                            		<?php
		                            ...
		                            <div class="modal-footer">
		                                <button type="submit" class="btn btn-gbr">Create Order</button>
		                                <a href="<?php echo HTTP.HTTPURL.CONTROLLERS.'/cartunset.php?action=early&from=createorder'; ?>">
                                    ...
                                    <tbody>
                                    	<?php
                                    		...
                                    		if(!empty($modresults)){
                                    			...
                                    			?>
                                    				<form method="post" action="createorder.php?action=add&code=<?php echo $modresults[$key]['mod_short_name']; ?>">
                                    					<tr>
															<!-- Short Name -->
															...
															<td><input type="submit" class="btn btn-gbr" value="Add To Order"/></td> <!-- Add To Order Button -->
														</tr>
                                    				</form>
                                    			<?php
                                    			}
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                    	<?php
                                    		if($_SESSION['order_type'] == "Sales" || $_SESSION['order_type'] == "Resale"){
	                                    		$modquery = $db->sql("SELECT * FROM modifications WHERE item_type = 'container' AND monthly = 0");
	                                    		$modresults = $db->getResult();
                                    		} elseif ($_SESSION['order_type'] == "Rental") {
                                    				...
                                    				<form method="post" action="createorder.php?action=add&code=<?php echo $modresults[$key]['mod_short_name']; ?>">
                                    					<tr>
															...
															<td>
																<div class="input-group">
																	<span class="input-group-addon" id="basic-addon1"><strong>$</strong></span>
																	<input type="text" name="cost" aria-describedby="basic-addon1" value="<?php if($_SESSION['order_type'] == "Rental"){echo $modresults[$key]["monthly"];}else{echo $modresults[$key]["mod_cost"];} ?>"/>
																</div>
															</td> <!-- Cost -->
															<td><input type="text" name="quantity" value="1" size="2"/></td> <!-- Quantity -->
															<td><input type="submit" class="btn btn-gbr" value="Add To Order"/></td> <!-- Add To Order Button -->
